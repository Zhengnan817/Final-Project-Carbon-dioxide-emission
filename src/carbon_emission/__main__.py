...
def main():
    ...
    print("-------------------------------------")
    print("Research Question 1: What is the carbon emissions from various sources (petroleum, natural gas, coal) within different states of the USA?")
    ...
    model_co2.map_fuel()
    print("-------------------------------------")
    print("Research Question 2:What is the predictive relationship between the annual real GDP of U.S. states and the various categories of carbon emissions (Residential, Commercial, Transportation, Electric Power, Industrial) for the years 2017 to 2022?")
